...
// Validación técnica: Previene inicialización fallida por variables de entorno faltantes
if (Object.values(firebaseConfig).some((value) => !value)) {
  throw new Error(
    "Firebase Config Error: Faltan variables de entorno. Revisa tu archivo .env local."
  );
}
