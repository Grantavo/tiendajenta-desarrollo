        ...
        <div className="flex-1 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative flex flex-col">
          {selectedClient ? (
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="px-8 -mt-16 pb-6 relative">
                <div className="flex justify-between items-end mb-6">
                  <div className="flex items-end gap-5">
                    {/* CORRECCIÓN: Eliminado conflicto de bg-white y bg-slate-100 */}
                    <div className="w-28 h-28 rounded-full p-1.5 shadow-xl flex items-center justify-center text-4xl font-bold text-slate-400 bg-slate-100 border-4 border-white">
                      {(selectedClient.name || "?")
                        .substring(0, 2)
                        .toUpperCase()}
                    </div>
                  ...
                  <button
                    ...
                    className="mb-4 bg-green-600 text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-green-600/30 flex items-center gap-2"
                  >
                    {" "}
